...
export const Hero = ({ lang, typedSubtitle, scrollToSection }: HeroProps) => {
  return (
    <div id="home" className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex-1 flex items-center justify-center">
        <div className="max-w-6xl mx-auto w-full">
          <div className="flex flex-col lg:flex-row items-center lg:items-center justify-center gap-6 sm:gap-8 lg:gap-12 xl:gap-16">
            {/* 左邊：個人照片 */}
            <motion.div
            ...
            >
              <div className="relative w-40 h-40 xs:w-48 xs:h-48 sm:w-56 sm:h-56 lg:w-64 lg:h-64 group">
                {/* 背景光暈效果 */}
            ...
            >
              ...
              <motion.h1
                ...
                className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4 lg:mb-6 gradient-text
                           tracking-tight"
              >
              ...
              <motion.div
                ...
                key={lang}
              >
                <p className="text-sm xs:text-base sm:text-lg md:text-xl text-slate-100 relative min-h-[2em] font-light leading-relaxed px-2 sm:px-0">
              ...
              <motion.div
                ...
                className="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 lg:gap-6 px-2 sm:px-0"
              >
                {/* 個人連結集合按鈕 */}
                <motion.div
