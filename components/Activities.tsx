                ...
                <Card className="card-modern">
                  <div className="relative">
                    ...
                    <div className="absolute top-4 right-4">
                      <span className="px-4 py-2 bg-gradient-to-r from-gray-500/30 to-slate-500/30 border border-gray-400/30 rounded-full text-sm font-semibold text-gray-100 shadow-glow flex items-center gap-2 transition-all duration-300 group-hover:scale-105">
